...
<asp:Content ID="gridContent" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="fieldsGrid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" AdjustPageSize="Auto" AllowSearch="True" SkinID="DetailsInTab" MatrixMode="true" Caption="Grouping Fields" CaptionVisible="true">
        <Levels>
